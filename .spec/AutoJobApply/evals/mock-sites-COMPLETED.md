...
- Smoke test run by eval-runner: all routes 200; gold JSON parses into pydantic models in Python side. Verified via [./eval-runner-COMPLETED.md](./eval-runner-COMPLETED.md).
